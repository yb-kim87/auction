...
import { logoutUser, updateMyProfile } from "@/lib/api";
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg }}>
      ...
      <nav style={{ background: C.white, borderBottom: `1px solid ${C.border}`, position: "sticky", top: 0, zIndex: 50 }}>
        ...
        >
          <Link href="/courses/my" aria-label="내 강의실" className="shrink-0" style={{ display: "flex", alignItems: "center", textDecoration: "none" }}>
            <div
              style={{
                height: 36,
                padding: "0 14px",

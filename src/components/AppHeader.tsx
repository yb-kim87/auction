...
export const HEADER_BTN =
  `text-sm flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-medium text-muted-foreground hover:text-foreground hover:bg-secondary/60 transition-colors`;
export const HEADER_TAB_ACTIVE =
  `text-sm flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-semibold text-primary bg-secondary`;

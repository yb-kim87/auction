...
import { fetchMyCourses, logoutUser, type LectureMyCourse } from "@/lib/api";
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg }}>
      ...
      <nav style={{ background: C.white, borderBottom: `1px solid ${C.border}`, position: "sticky", top: 0, zIndex: 50 }}>
        ...
        >
          <Link href="/courses/my" aria-label="내 강의실" style={{ display: "flex", alignItems: "center", textDecoration: "none" }}>
            <div
              style={{
                height: 36,
                padding: "0 14px",
      ...
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "32px 24px", display: "flex", flexDirection: "column", gap: 32 }}>
        ...
        {/* ── 안내사항 (질문하기 아래, 강조색 없이, 사용자 요청 2026-08-19) ── */}
        <section
          style={{
            background: C.white,
            border: `1px solid ${C.border}`,
        ...
        >
          <p style={{ fontSize: 13, fontWeight: 700, color: C.textSecondary, margin: "0 0 8px" }}>안내사항</p>
          <ul style={{ margin: 0, paddingLeft: 18, display: "flex", flexDirection: "column", gap: 4 }}>
            <li style={{ fontSize: 13, color: C.textDim, lineHeight: 1.6 }}>이 강의실은 결제하신 수강생만 이용하실 수 있는 공간입니다.</li>
            <li style={{ fontSize: 13, color: C.textDim, lineHeight: 1.6 }}>
